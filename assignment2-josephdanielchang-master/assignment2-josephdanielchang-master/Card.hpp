...
//
//  Modified by vikash Gilja on 4/10/20
//
...
public:
    ...
    // card game values
    enum FaceEnum {ACE=1, TWO, THREE, FOUR, FIVE, SIX, SEVEN, EIGHT, NINE, TEN, JACK, QUEEN, KING};
    enum SuitEnum {SPADE=0, DIAMOND, HEART, CLUB};
